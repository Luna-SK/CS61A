...
CREATE TABLE sentences AS
  SELECT "The two siblings, " || first || " plus " || second || " have the same size: " || c.size
    from siblings, size_of_dogs as c, size_of_dogs as d where first=c.name and second=d.name and c.size=d.size;
